    ...
    content: `
      <div class ="macro_window" style="margin-bottom : 7px;">
        <div class="grid grid-2col" style="grid-template-columns: 150px auto">
          <div class="macro_img"><img src="systems/mosh-fork/images/icons/ui/rolltables/death_save.png" style="border:none"/></div>
    ...
    buttons: [
      {
        ...
        callback: () => game.mosh.initRollTable(game.settings.get('mosh-fork','table0eDeath'),`1d10 [+]`,`high`,false,false,null,null),
